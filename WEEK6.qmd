...
[Machine learning](https://en.wikipedia.org/wiki/Machine_learning) is based on data and it can help us make decisions or predictions without explicit programming, which also known as training. There are many models in machine learning, including the linear regression model that many people are familiar with.

Classification and regression trees (CART)-classification & regression
